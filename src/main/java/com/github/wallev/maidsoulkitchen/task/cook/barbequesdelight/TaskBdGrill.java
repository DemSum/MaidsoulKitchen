...
public class TaskBdGrill implements ICookTask<GrillBlockEntity, GrillingRecipe<?>> {
    ...
    public List<Pair<Integer, BehaviorControl<? super EntityMaid>>> createBrainTasks(EntityMaid maid) {
        ...
        MaidCookMakePathingTask<GrillBlockEntity> pathingTask = new MaidCookMakePathingTask<>(this);
        return Lists.newArrayList(Pair.of(5, maidCookMoveTask), Pair.of(6, maidGrillMakeTask), Pair.of(7, pathingTask));
    }
