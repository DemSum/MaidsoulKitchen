...
//import java.util.*;
//
//public class VerifyExistenceOri {
...
//
//        Map<String, VerifyExistence.ClazzInfo> allClazzInfo = new HashMap<>();
//        for (String clazz : taskClazzInfo.allClazzs()) {
//            VerifyExistence.ClazzInfo clazzInfo = VerifyExistence.ClazzInfo.create(clazz);
//            if (clazzInfo != null) {
...
//    public static boolean verify(ClassAnalysisResult result, Map<String, VerifyExistence.ClazzInfo> allClazzInfo) {
...
//            VerifyExistence.ClazzInfo clazzInfo = allClazzInfo.get(className);
//            if (clazzInfo != null) {
