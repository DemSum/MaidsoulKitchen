...
//     */
//    public static List<String> getAllMethodsIncludingInherited(Class<?> targetClass){
...
//
//        ASMMemberSignatureCollector asmMemberSignatureCollector = new ASMMemberSignatureCollector();
//
...
//
//            try {
//                List<String> strings = asmMemberSignatureCollector.collectMemberSignatures(currentClass);
//                int a = 1;
//            } catch (IOException e) {
//                e.printStackTrace();
