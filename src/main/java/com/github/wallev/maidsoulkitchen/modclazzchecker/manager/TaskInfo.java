...
//    @TaskErrorLang(en_us = "CrockPot CrockPot", zh_cn = "烹饪锅 烹饪锅(烹饪)")
    ...
    FD_SKILLET("fd_skillet", Mods.FD, () -> RegisterConfig.FD_SKILLET_TASK_ENABLED.get()),
    ;
    ...
    // -----------------------------------------------------------TaskInfo----------------------------------------------------------------//
    TaskInfo(ResourceLocation uid, Mods bindMod, Supplier<ModConfigSpec.BooleanValue> bindConfig, TaskInfo... dependTasks) {
        this.uid = uid;
    ...
    TaskInfo(String oldName, String uid, Mods bindMod, boolean concatModId, Supplier<ModConfigSpec.BooleanValue> bindConfig, TaskInfo... dependTasks) {
    ...
    TaskInfo(String oldName, String blockId, String recipeId, Mods bindMod, boolean concatModId, Supplier<ModConfigSpec.BooleanValue> bindConfig, TaskInfo... dependTasks) {
        this.oldName = VResourceLocation.createMod(oldName).toString();
    ...
    TaskInfo(String uid, Mods bindMod, boolean concatModId, Supplier<ModConfigSpec.BooleanValue> bindConfig, TaskInfo... dependTasks) {
        this("", uid, bindMod, concatModId, bindConfig, dependTasks);
    }

    TaskInfo(String uid, Mods bindMod, Supplier<ModConfigSpec.BooleanValue> bindConfig, TaskInfo... dependTasks) {
